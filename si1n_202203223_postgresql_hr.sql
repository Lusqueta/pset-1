...
-- cria um usuario e da privilegios
CREATE USER lucas WITH ENCRYPTED PASSWORD '123';

-- cria um banco de dados fresco
-- DROP DATABASE uvv;
CREATE DATABASE uvv WITH OWNER = lucas ENCODING = "UTF8" TEMPLATE = template0 ALLOW_CONNECTIONS = true;

-- garante todos os privilegios ao usuario recem criado (somente em desenvolvimento)
GRANT all privileges ON DATABASE uvv TO lucas;
...
COMMENT ON TABLE hr.cargos IS 'Tabela de cargo;';

COMMENT ON COLUMN hr.cargos.id_cargo IS 'codigo de identificação da tabela';

COMMENT ON COLUMN hr.cargos.cargo IS 'titulo do cargo';

COMMENT ON COLUMN hr.cargos.salario_minimo IS 'slario minimo';

COMMENT ON COLUMN hr.cargos.salario_maximo IS 'salario maximo';

CREATE UNIQUE INDEX cargo ON hr.cargos (cargo);
...
COMMENT ON COLUMN hr.regioes.id_regiao IS 'identificador do codigo da regiao';

COMMENT ON COLUMN hr.regioes.nome IS 'sigla da regiao';

CREATE UNIQUE INDEX nome ON hr.regioes (nome);
...
COMMENT ON TABLE hr.paises IS 'Tabela de paises;';

COMMENT ON COLUMN hr.paises.id_pais IS 'identificador do pais';

COMMENT ON COLUMN hr.paises.nome IS 'nome do pais';

COMMENT ON COLUMN hr.paises.id_regiao IS 'identificador da regiao';

CREATE UNIQUE INDEX nome_pais ON hr.paises (nome);
...
COMMENT ON TABLE hr.localizacoes IS 'Tabela de localizacoes;';

COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'codigo idenficador da localizacao';

COMMENT ON COLUMN hr.localizacoes.endereco IS 'endereço da localizacao';

COMMENT ON COLUMN hr.localizacoes.cep IS 'cep da localização';

COMMENT ON COLUMN hr.localizacoes.cidade IS 'cidade da localizacao';

COMMENT ON COLUMN hr.localizacoes.uf IS 'uf da localizacao';

COMMENT ON COLUMN hr.localizacoes.id_pais IS 'codigo do pais';
...
COMMENT ON TABLE hr.departamentos IS 'Tabela de departamentos;';

COMMENT ON COLUMN hr.departamentos.id_departamento IS 'codigo de identificacao da tabela';

COMMENT ON COLUMN hr.departamentos.nome IS 'nome do departamento';

COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'identificador da localizacao do departamento';

COMMENT ON COLUMN hr.departamentos.id_gerente IS 'codigo identificador de gerente';

CREATE UNIQUE INDEX departamentos_idx ON hr.departamentos (nome);
...
COMMENT ON COLUMN hr.empregados.id_empregado IS 'codigo identificador de empregado';
...
COMMENT ON COLUMN hr.empregados.data_contratacao IS 'data de contratacao do empregado';

COMMENT ON COLUMN hr.empregados.id_cargo IS 'codigo do cargo desse funcionario';
...
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'codigo identificador do supervisor';

COMMENT ON COLUMN hr.empregados.id_departamento IS 'codigo do departamento desse funcionario';

CREATE UNIQUE INDEX email ON hr.empregados (email);
...
COMMENT ON TABLE hr.historico_cargos IS 'Tabela de historico de cargos;';

COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'codigo identificador do empregado';

COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'identificador da data inicial';

COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'codigo do cargo';

COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'codigo do departamento';

ALTER TABLE
  hr.historico_cargos
ADD
  CONSTRAINT cargos_historico_cargos_fk FOREIGN KEY (id_cargo) REFERENCES hr.cargos (id_cargo) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.empregados
ADD
  CONSTRAINT cargos_empregados_fk FOREIGN KEY (id_cargo) REFERENCES hr.cargos (id_cargo) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.paises
ADD
  CONSTRAINT regioes_paises_fk FOREIGN KEY (id_regiao) REFERENCES hr.regioes (id_regiao) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.localizacoes
ADD
  CONSTRAINT paises_localizacoes_fk FOREIGN KEY (id_pais) REFERENCES hr.paises (id_pais) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.departamentos
ADD
  CONSTRAINT localizacoes_departamentos_fk FOREIGN KEY (id_localizacao) REFERENCES hr.localizacoes (id_localizacao) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.empregados
ADD
  CONSTRAINT departamentos_empregados_fk FOREIGN KEY (id_departamento) REFERENCES hr.departamentos (id_departamento) ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE
  hr.historico_cargos
ADD
  CONSTRAINT departamentos_historico_cargos_fk FOREIGN KEY (id_departamento) REFERENCES hr.departamentos (id_departamento) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.historico_cargos
ADD
  CONSTRAINT empregados_historico_cargos_fk FOREIGN KEY (id_empregado) REFERENCES hr.empregados (id_empregado) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.empregados
ADD
  CONSTRAINT empregados_empregados_fk FOREIGN KEY (id_supervisor) REFERENCES hr.empregados (id_empregado) ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;

ALTER TABLE
  hr.departamentos
ADD
  CONSTRAINT empregados_departamentos_fk FOREIGN KEY (id_gerente) REFERENCES hr.empregados (id_empregado) ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED;
